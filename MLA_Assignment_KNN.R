...
#Continuous Variables
contVar<-heart_data[, c(1,3,4,6,8)]
...
dim(k_summary)
k_summary[1:10, ]
plot(k_summary, main="Misclassification Rate to Values of K")
######## NOT FINISHED ###################
minVal<-min(k_summary[,2])
minVal
...
################################################################################################################################################
#K Nearest Neighbours Normal 9 vars
#############################################################################################################################################
...
################################################################################################################################################
#K Nearest Neighbours 9 Vars Scaled
#############################################################################################################################################
...
contVar<-heart_data[, c(1,3,4,6,9)]
contVar<-scale(contVar)
contVar<-cbind(contVar,heart_data[,c(2,5,7,8)])
contVar
#for testing, and 1/3 for validation
index_train <- c(1:90) #First third
index_test <- c(91:180) #Second third
